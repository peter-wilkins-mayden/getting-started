...
figwheel.client.socket.open = (function figwheel$client$socket$open(p__41609){
...
var opts = map__41612__$1;
var retry_count = cljs.core.get.call(null,map__41612__$1,new cljs.core.Keyword(null,"retry-count","retry-count",1936122875));
var retried_count = cljs.core.get.call(null,map__41612__$1,new cljs.core.Keyword(null,"retried-count","retried-count",-2127867357));
var websocket_url = cljs.core.get.call(null,map__41612__$1,new cljs.core.Keyword(null,"websocket-url","websocket-url",-490444938));
var build_id = cljs.core.get.call(null,map__41612__$1,new cljs.core.Keyword(null,"build-id","build-id",1642831089));
...
socket.onmessage = ((function (url,socket,WebSocket,temp__4655__auto__,map__41612,map__41612__$1,opts,retry_count,retried_count,websocket_url,build_id){
...
var and__29667__auto__ = cljs.core.map_QMARK_.call(null,msg);
if(and__29667__auto__){
var and__29667__auto____$1 = new cljs.core.Keyword(null,"msg-name","msg-name",-353709863).cljs$core$IFn$_invoke$arity$1(msg);
if(cljs.core.truth_(and__29667__auto____$1)){
var and__29667__auto____$2 = cljs.core.not_EQ_.call(null,new cljs.core.Keyword(null,"msg-name","msg-name",-353709863).cljs$core$IFn$_invoke$arity$1(msg),new cljs.core.Keyword(null,"ping","ping",-1670114784));
...
});})(url,socket,WebSocket,temp__4655__auto__,map__41612,map__41612__$1,opts,retry_count,retried_count,websocket_url,build_id))
;

socket.onopen = ((function (url,socket,WebSocket,temp__4655__auto__,map__41612,map__41612__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (x){
...
socket.onclose = ((function (url,socket,WebSocket,temp__4655__auto__,map__41612,map__41612__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (x){
var retried_count__$1 = (function (){var or__29679__auto__ = retried_count;
...
return setTimeout(((function (retried_count__$1,url,socket,WebSocket,temp__4655__auto__,map__41612,map__41612__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (){
...
});})(retried_count__$1,url,socket,WebSocket,temp__4655__auto__,map__41612,map__41612__$1,opts,retry_count,retried_count,websocket_url,build_id))
,(function (){var x__30017__auto__ = (10000);
var y__30018__auto__ = ((2000) + ((500) * retried_count__$1));
...
socket.onerror = ((function (url,socket,WebSocket,temp__4655__auto__,map__41612,map__41612__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (x){
...
//# sourceMappingURL=socket.js.map?rel=1466782848044