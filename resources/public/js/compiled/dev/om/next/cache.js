...
var self__ = this;
var this$ = this;
var x_SINGLEQUOTE__32149 = cljs.core.vary_meta.call(null,x,cljs.core.assoc,new cljs.core.Keyword(null,"client-time","client-time",-1212214195),(new Date()));
if((self__.size <= self__.arr.length)){
var id_SINGLEQUOTE__32150 = self__.arr.shift();
cljs.core.swap_BANG_.call(null,self__.index,((function (id_SINGLEQUOTE__32150,x_SINGLEQUOTE__32149,this$){
return (function (p1__32148_SHARP_){
return cljs.core.assoc.call(null,cljs.core.dissoc.call(null,p1__32148_SHARP_,id_SINGLEQUOTE__32150),id,x_SINGLEQUOTE__32149);
});})(id_SINGLEQUOTE__32150,x_SINGLEQUOTE__32149,this$))
);
} else {
cljs.core.swap_BANG_.call(null,self__.index,cljs.core.assoc,id,x_SINGLEQUOTE__32149);
}
...
om.next.cache.Cache.cljs$lang$ctorPrWriter = (function (this__30285__auto__,writer__30286__auto__,opt__30287__auto__){
return cljs.core._write.call(null,writer__30286__auto__,"om.next.cache/Cache");
});
...
//# sourceMappingURL=cache.js.map?rel=1466782831875