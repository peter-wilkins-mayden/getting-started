...
var reader = (function (){var or__29679__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__29679__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__29679__auto__)){
return or__29679__auto__;
} else {
return (128);
...
var line = cljs.core.get.call(null,map__34951__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__34951__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.sanity_hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e34950){var _e = e34950;
return false;
}});
...
var temp__4657__auto___34953 = devtools.sanity_hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___34953)){
var sense_34954 = temp__4657__auto___34953;
self.message = [cljs.core.str(self.message),cljs.core.str(", a sanity hint:\n"),cljs.core.str(sense_34954)].join('');
} else {
}
}
} else {
...
if(cljs.core.truth_((function (){var and__29667__auto__ = cljs.core.not.call(null,devtools.sanity_hints._STAR_installed_QMARK__STAR_);
...
//# sourceMappingURL=sanity_hints.js.map?rel=1466782838020